...
num_classes = 4	# The number of possible labels ("0","1",..."9")
...
y_train = np.concatenate((y_train, len(plus)*[0]), axis = 0)
x_test = np.concatenate((x_test, plus6), axis = 0)
y_test = np.concatenate((y_test, len(plus6)*[0]), axis = 0)
...
x_train = np.concatenate((x_train, plus), axis = 0)
y_train = np.concatenate((y_train, len(plus)*[1]), axis = 0)
x_test = np.concatenate((x_test, plus6), axis = 0)
y_test = np.concatenate((y_test, len(plus6)*[1]), axis = 0)
...
x_train = np.concatenate((x_train, plus), axis = 0)
y_train = np.concatenate((y_train, len(plus)*[2]), axis = 0)
y_test = np.concatenate((y_test, len(plus6)*[2]), axis = 0)
x_test = np.concatenate((x_test, plus6), axis = 0)
...
x_train = np.concatenate((x_train, plus), axis = 0)
y_train = np.concatenate((y_train, len(plus)*[3]), axis = 0)
x_test = np.concatenate((x_test, plus6), axis = 0)
y_test = np.concatenate((y_test, len(plus6)*[3]), axis = 0)
